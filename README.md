...
| `annotationandinterface` | Custom annotations and shared interfaces |
...
The project includes a smoke test validating Spring Boot context loading:

```kotlin
@SpringBootTest
class NoirApplicationTests {
    @Test
    fun contextLoads() {
    }
}
